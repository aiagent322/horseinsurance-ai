export const NATIVE_POLICY_REPORT_PAGES = [
  {
    page: 1,
...
The Company will indemnify the Insured for theft of an insured horse and death directly resulting from theft, subject to immediate notice, the Schedule, the limit, the deductible, and the exclusions.`
  },
  {
    page: 2,
    text: `PART III. CONDITIONS
The horse shall be used only for the declared use. The Insured shall be the sole owner. Territorial limits are the continental USA and Canada unless endorsed.
...
7. The Insured shall: (a) at all times provide proper care and attention to the Insured Horse; (b) in the event of any illness, disease, lameness, injury, accident or physical disability whatsoever of an Insured Horse, immediately at the Insured's own expense employ a licensed veterinarian; (c) in the event of the death of an Insured Horse immediately arrange a postmortem and necropsy examination by a licensed veterinarian; (d) in the event of either (b) or (c) immediately give telephone notice to the person or firm named in Item G of the Declarations.

8. In the event of theft or disappearance of an Insured Horse, the Insured shall immediately give notice to the person named in Item G of the Declarations. The Insured shall also immediately report any theft or disappearance to the police and other appropriate law enforcement agencies and shall follow their recommendations and the Insured shall not pay or promise to pay a ransom or give similar assurances.

9. After an insured loss, the Insured shall render a detailed,`
  },
  {
    page: 3,
    text: `sworn proof of loss within sixty (60) days. Upon request of the Company, the Insured shall submit to examinations under oath and shall cause their agents, employees and representatives to submit to examinations under oath. The Insured shall produce for examination all books, documents, records, receipts and invoices.
